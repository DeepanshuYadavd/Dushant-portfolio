...
const words = [
  ...
  "Proficient in DaVinci & Premiere",
  ...
  return (
    <section className="relative flex justify-center  overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden select-none ">
        {["COLORIST", "STORYTELLER", "EDITOR", "CINEMATIC", "MOTION"].map(
          (word, i) => (
            <motion.span
              key={i}
              ...
              style={{
                top: `${20 * i}%`,
                left: `${15 * i}%`,
                display: i > 2 ? "none" : "block", // Show fewer words on mobile to avoid clutter
              }}
            >
              {word}
            </motion.span>
          ...
          <div className="">
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.96 }}
                className="group !relative !px-8 md:!px-8 !py-2 md:!py-4 cursor-pointer !rounded-full !bg-white !text-black !font-bold !overflow-hidden !transition-shadow hover:!shadow-[0_0_40px_rgba(255,255,255,0.4)] !w-full sm:!w-auto"
              >
                <div className="!relative !z-10 !flex !items-center !justify-center !gap-3">
                  <Play size={18} fill="black" />
                  <span className="!text-sm md:!text-base">Watch Showreel</span>
                </div>
